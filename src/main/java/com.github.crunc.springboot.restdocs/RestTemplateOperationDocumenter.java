...
public class RestTemplateOperationDocumenter {
    ...
    public RestTemplateOperationDocumenter document(
        ...
        final Map<String, Object> attrs = new HashMap<String, Object>(4);
        ...
        final OperationResponse operationRes = responsePreprocessor.preprocess(operationResponseFactory.createOperationResponse(url, method, res));
        ...
        for (final Snippet snippet : context.defaultSnippets()) {
            try {
                ...
                throw new RuntimeException("failed to extract documentation", e);
            }
        }
    ...
    private static class IdentityOperationRequestPreprocessor implements OperationRequestPreprocessor {
        ...
        static OperationRequestPreprocessor Instance = new IdentityOperationRequestPreprocessor();
    ...
    private static class IdentityOperationResponsePreprocessor implements OperationResponsePreprocessor {
        ...
        static OperationResponsePreprocessor Instance = new IdentityOperationResponsePreprocessor();
